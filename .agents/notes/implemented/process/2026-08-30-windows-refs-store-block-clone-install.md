...
The Windows install steps in [ci.yml](../../../../.github/workflows/) (the four pull-request native jobs) and [ci-master.yml](../../../../.github/workflows/) (`serial-windows`) branch on the workspace filesystem, using clone only on ReFS:
